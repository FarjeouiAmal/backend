  ...
  imports: [
    ...
    MailerModule.forRootAsync({
      useFactory: (configService: ConfigService) => ({
        transport: {
          host: configService.get('sandbox.smtp.mailtrap.io'),
          port: configService.get('25 or 465 or 587 or 2525'),
          secure: false, // Set to true if using TLS
          auth: {
            user: configService.get('18173129757767'),
            pass: configService.get('73b4087b664781'),
          },
        },
        defaults: {
